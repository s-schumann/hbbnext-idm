class ApplicationController < ActionController::Base
  ...
  $currentVersion = "v3"
  $currentRelease = "1.4.0" # X.Y.Z  X-LAST milestone (min. 1), Y-release, Z-increment. Tag starts at 1.0.0, afterwards increase with release. -dev added until new release ready.
